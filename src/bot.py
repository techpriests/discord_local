        ...
        try:
            ...
            for command_class in self._command_classes:
                try:
                    ...
                    elif command_class in [TeamDraftCommands, RosterCommands, FateReplayCommands, DataBackupCommands]:
